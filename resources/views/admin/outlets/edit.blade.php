    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.outlets.update", [$outlet->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $outlet->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maps') ? 'is-invalid' : '' }}" type="text" name="maps" id="maps" value="{{ old('maps', $outlet->maps) }}" required>
                @if($errors->has('maps'))
                    <div class="invalid-feedback">
                        {{ $errors->first('maps') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $outlet->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('est') ? 'is-invalid' : '' }}" type="text" name="est" id="est" value="{{ old('est', $outlet->est) }}" required>
                @if($errors->has('est'))
                    <div class="invalid-feedback">
                        {{ $errors->first('est') }}
                    </div>
